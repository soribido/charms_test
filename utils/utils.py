...
def create_logdir(name: str, resume_training: bool, wandb_logger):
    basepath = join(os.path.dirname(
        os.path.abspath(sys.argv[0])), 'runs', name)
    ...
    if target.lower() == 'dvm_origin':
        transform = transforms.Compose([
            transforms.RandomApply([transforms.ColorJitter(
                brightness=0.8, contrast=0.8, saturation=0.8)], p=0.8),
            transforms.RandomGrayscale(p=0.2),
            transforms.RandomApply([transforms.GaussianBlur(
                kernel_size=29, sigma=(0.1, 2.0))], p=0.5),
            transforms.RandomResizedCrop(size=(img_size, img_size), scale=(
                crop_scale_lower, 1.0), ratio=(0.75, 1.3333333333333333)),
    ...
    if target.lower() == 'dvm_origin':
        transform = transforms.Compose([
            ...
            transforms.RandomApply([transforms.GaussianBlur(
                kernel_size=29, sigma=(0.1, 2.0))], p=0.5),
            transforms.RandomResizedCrop(size=(img_size, img_size), scale=(
                0.6, 1.0), ratio=(0.75, 1.3333333333333333)),
            transforms.RandomHorizontalFlip(p=0.5),
            transforms.Resize(size=(img_size, img_size)),
            # transforms.Lambda(lambda x : x.float())
            transforms.Lambda(lambda x: x/255.0)
...
def grab_wids(category: str):
    # boat
    wids_b = ['n02951358', 'n03447447', 'n04612504',
              'n03344393', 'n03662601', 'n04273569']
    # domestic cat
    wids_c = ['n02123597', 'n02123159', 'n02123045', 'n02124075', 'n02123394']
    # domestic dog
    wids_d = ['n02102480', 'n02096585', 'n02093256', 'n02091831', 'n02086910', 'n02100735', 'n02102040', 'n02085936', 'n02097130', 'n02097047', 'n02106662', 'n02110958', 'n02097209', 'n02092002', 'n02107142', 'n02099712', 'n02093754', 'n02112018', 'n02105412', 'n02096437', 'n02105251', 'n02108089', 'n02108551', 'n02095889', 'n02113624', 'n02093428', 'n02088238', 'n02100877', 'n02099849', 'n02108422', 'n02098413', 'n02086240', 'n02107574', 'n02101556', 'n02099429', 'n02098105', 'n02087394', 'n02108000', 'n02106166', 'n02107683', 'n02091244', 'n02101388', 'n02111889', 'n02093647', 'n02102973', 'n02101006', 'n02109961', 'n02085782', 'n02091635', 'n02112706', 'n02090622', 'n02110063', 'n02113712', 'n02110341', 'n02086079', 'n02089973', 'n02112350', 'n02113799', 'n02105162',
              'n02108915', 'n02104029', 'n02089867', 'n02098286', 'n02105505', 'n02110627', 'n02106550', 'n02105641', 'n02100583', 'n02090721', 'n02093859', 'n02113978', 'n02088466', 'n02095570', 'n02099267', 'n02099601', 'n02106030', 'n02112137', 'n02089078', 'n02092339', 'n02088632', 'n02102177', 'n02096051', 'n02096294', 'n02096177', 'n02093991', 'n02110185', 'n02111277', 'n02090379', 'n02111500', 'n02088364', 'n02088094', 'n02094114', 'n02104365', 'n02111129', 'n02109525', 'n02097658', 'n02113186', 'n02095314', 'n02113023', 'n02087046', 'n02094258', 'n02100236', 'n02097298', 'n02105855', 'n02085620', 'n02106382', 'n02091032', 'n02110806', 'n02086646', 'n02094433', 'n02091134', 'n02107312', 'n02107908', 'n02097474', 'n02091467', 'n02102318', 'n02105056', 'n02109047']
